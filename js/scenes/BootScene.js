export default class BootScene extends Phaser.Scene {
    ...
    createAnimations() {
        ...
        this.anims.create({
            key: 'grown-mario-run',
            frames: this.anims.generateFrameNumbers('mario_grown', { start: 3, end: 1 }),
            frameRate: 12,
            repeat: -1
        });
        this.anims.create({
        ...
        this.anims.create({
            key: 'fire-mario-run',
            frames: this.anims.generateFrameNumbers('mario_fire', { start: 3, end: 1 }),
            frameRate: 12,
            repeat: -1
        });
        this.anims.create({
        ...
        this.anims.create({
            ...
            frames: this.anims.generateFrameNumbers('ground_coin', { start: 2, end: 0 }),
            frameRate: 5,
            repeat: -1,
            repeatDelay: 5
        });
        ...
        this.anims.create({
            ...
            frames: this.anims.generateFrameNumbers('misteryBlock', { start: 2, end: 0 }),
            frameRate: 5,
            repeat: -1,
            repeatDelay: 5
        });
        ...
        this.anims.create({
            ...
            frames: this.anims.generateFrameNumbers('customBlock', { start: 2, end: 0 }),
            frameRate: 5,
            repeat: -1,
            repeatDelay: 5
        });
        ...
        this.anims.create({
            ...
            frames: this.anims.generateFrameNumbers('brickDebris', { start: 0, end: 3 }),
            frameRate: 4,
            repeat: -1,
        });
        ...
        this.anims.create({
            ...
            frames: this.anims.generateFrameNumbers('fire_flower', { start: 0, end: 3 }),
            frameRate: 10,
            repeat: -1,
        });
